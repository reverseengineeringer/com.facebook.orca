.class public Lcom/facebook/user/model/PicSquareDeserializer;
.super Lcom/facebook/common/json/FbJsonDeserializer;
.source "PicSquareDeserializer.java"
...
.method static constructor <clinit>()V
    ...
    new-instance v1, Lcom/facebook/user/model/PicSquareDeserializer;

    invoke-direct {v1}, Lcom/facebook/user/model/PicSquareDeserializer;-><init>()V

    invoke-static {v0, v1}, Lcom/facebook/common/json/j;->a(Ljava/lang/Class;Lcom/fasterxml/jackson/databind/JsonDeserializer;)V

    .line 40
    invoke-static {}, Lcom/facebook/user/model/PicSquareDeserializer;->e()Ljava/util/Map;
...
.method private static declared-synchronized e()Ljava/util/Map;
    ...
    .prologue
    .line 44
    const-class v1, Lcom/facebook/user/model/PicSquareDeserializer;

    monitor-enter v1

    :try_start_0
    sget-object v0, Lcom/facebook/user/model/PicSquareDeserializer;->a:Ljava/util/Map;
    :try_end_0
    ...
    .line 47
    const-string v2, "picSquareUrls"

    const-class v3, Lcom/facebook/user/model/PicSquare;

    const-string v4, "mPicSquareUrlsWithSizes"

    invoke-virtual {v3, v4}, Ljava/lang/Class;->getDeclaredField(Ljava/lang/String;)Ljava/lang/reflect/Field;

    move-result-object v3

    const-class v4, Lcom/facebook/user/model/PicSquareUrlWithSize;
    ...
    sput-object v0, Lcom/facebook/user/model/PicSquareDeserializer;->a:Ljava/util/Map;
    :try_end_1
