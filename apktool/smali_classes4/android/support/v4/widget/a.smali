...
.method public constructor <init>(Landroid/view/View;)V
    ...
    .line 294
    iget-object v7, p0, Landroid/support/v4/widget/a;->k:[F
    ...
    invoke-direct {p0, v1, v0}, Landroid/support/v4/widget/a;->b(FF)Landroid/support/v4/widget/a;

    .line 218
    const/4 v0, 0x1

    .line 354
    iput v0, p0, Landroid/support/v4/widget/a;->g:I
    ...
    .line 221
    invoke-direct {p0, v5, v5}, Landroid/support/v4/widget/a;->c(FF)Landroid/support/v4/widget/a;
    ...
    .line 427
    iget-object v7, p0, Landroid/support/v4/widget/a;->a:Landroid/support/v4/widget/b;

    invoke-virtual {v7, v0}, Landroid/support/v4/widget/b;->a(I)V
    ...
    invoke-virtual {v7, v0}, Landroid/support/v4/widget/b;->b(I)V
...
.method public static b(Landroid/support/v4/widget/a;)Z
    .locals 2
...
.method private c(FF)Landroid/support/v4/widget/a;
    .locals 4
...
.method public onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    .line 460
    :cond_1
    invoke-static {p2}, Landroid/support/v4/view/ax;->a(Landroid/view/MotionEvent;)I
    ...
    invoke-static {p0}, Landroid/support/v4/widget/a;->b(Landroid/support/v4/widget/a;)Z
    ...
    .line 504
    iget-object v6, p0, Landroid/support/v4/widget/a;->d:Ljava/lang/Runnable;

    if-nez v6, :cond_3

    .line 505
    new-instance v6, Landroid/support/v4/widget/c;

    const/4 v7, 0x0

    invoke-direct {v6, p0}, Landroid/support/v4/widget/c;-><init>(Landroid/support/v4/widget/a;)V

    iput-object v6, p0, Landroid/support/v4/widget/a;->d:Ljava/lang/Runnable;

    .line 508
    :cond_3
    iput-boolean v10, p0, Landroid/support/v4/widget/a;->o:Z

    .line 509
    iput-boolean v10, p0, Landroid/support/v4/widget/a;->m:Z

    .line 511
    iget-boolean v6, p0, Landroid/support/v4/widget/a;->l:Z

    if-nez v6, :cond_4

    iget v6, p0, Landroid/support/v4/widget/a;->h:I

    if-lez v6, :cond_4

    .line 512
    iget-object v6, p0, Landroid/support/v4/widget/a;->c:Landroid/view/View;

    iget-object v7, p0, Landroid/support/v4/widget/a;->d:Ljava/lang/Runnable;

    iget v8, p0, Landroid/support/v4/widget/a;->h:I

    int-to-long v8, v8

    invoke-static {v6, v7, v8, v9}, Landroid/support/v4/view/ViewCompat;->a(Landroid/view/View;Ljava/lang/Runnable;J)V

    .line 519
    :goto_2
    iput-boolean v10, p0, Landroid/support/v4/widget/a;->l:Z
