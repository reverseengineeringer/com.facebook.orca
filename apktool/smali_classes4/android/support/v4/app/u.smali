...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/app/u;->a:[Ljava/lang/String;
...
.method public constructor <init>(Landroid/view/LayoutInflater;Landroid/support/v4/app/Fragment;)V
    ...
    .line 31
    iput-object p1, p0, Landroid/support/v4/app/u;->b:Landroid/view/LayoutInflater;

    .line 32
    iput-object p2, p0, Landroid/support/v4/app/u;->c:Landroid/support/v4/app/Fragment;
...
.method public final cloneInContext(Landroid/content/Context;)Landroid/view/LayoutInflater;
    ...
    iget-object v1, p0, Landroid/support/v4/app/u;->b:Landroid/view/LayoutInflater;
    ...
    iget-object v2, p0, Landroid/support/v4/app/u;->c:Landroid/support/v4/app/Fragment;

    invoke-direct {v0, v1, v2}, Landroid/support/v4/app/u;-><init>(Landroid/view/LayoutInflater;Landroid/support/v4/app/Fragment;)V
...
.method public final getContext()Landroid/content/Context;
    ...
    .prologue
    .line 44
    iget-object v0, p0, Landroid/support/v4/app/u;->b:Landroid/view/LayoutInflater;
...
.method public final inflate(Lorg/xmlpull/v1/XmlPullParser;Landroid/view/ViewGroup;Z)Landroid/view/View;
    ...
    .line 108
    invoke-virtual {v0}, Landroid/support/v4/app/af;->r()Landroid/support/v4/app/ag;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/app/af;->a(Landroid/support/v4/app/ag;)V

    .line 111
    iget-object v2, p0, Landroid/support/v4/app/u;->b:Landroid/view/LayoutInflater;
    ...
    .line 114
    invoke-virtual {v0, v1}, Landroid/support/v4/app/af;->a(Landroid/support/v4/app/ag;)V
...
.method protected final onCreateView(Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    .prologue
    .line 78
    sget-object v2, Landroid/support/v4/app/u;->a:[Ljava/lang/String;
    ...
    .line 80
    :try_start_0
    iget-object v4, p0, Landroid/support/v4/app/u;->b:Landroid/view/LayoutInflater;
