.class public final Landroid/support/v7/internal/widget/ar;
...
# direct methods
.method public constructor <init>(Landroid/support/v7/internal/widget/an;Landroid/content/Context;Landroid/support/v7/app/b;Z)V
    .locals 4
    ...
    .line 383
    iput-object p3, p0, Landroid/support/v7/internal/widget/ar;->c:Landroid/support/v7/app/b;
    ...
    invoke-static {p2, v3, v0, v1, v2}, Landroid/support/v7/internal/widget/bi;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/internal/widget/bi;
    ...
    .line 396
    :cond_1
    invoke-direct {p0}, Landroid/support/v7/internal/widget/ar;->b()V
...
.method private b()V
    ...
    .line 442
    iget-object v2, p0, Landroid/support/v7/internal/widget/ar;->c:Landroid/support/v7/app/b;

    .line 443
    invoke-virtual {v2}, Landroid/support/v7/app/b;->d()Landroid/view/View;
    ...
    .line 462
    :cond_5
    invoke-virtual {v2}, Landroid/support/v7/app/b;->b()Landroid/graphics/drawable/Drawable;

    move-result-object v0

    .line 463
    invoke-virtual {v2}, Landroid/support/v7/app/b;->c()Ljava/lang/CharSequence;
    ...
    invoke-direct {v4, v5, v7, v6}, Landroid/support/v7/internal/widget/ad;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {v2}, Landroid/support/v7/app/b;->f()Ljava/lang/CharSequence;
...
.method public final a()Landroid/support/v7/app/b;
    ...
    .prologue
    .line 535
    iget-object v0, p0, Landroid/support/v7/internal/widget/ar;->c:Landroid/support/v7/app/b;
...
.method public final a(Landroid/support/v7/app/b;)V
    ...
    .prologue
    .line 400
    iput-object p1, p0, Landroid/support/v7/internal/widget/ar;->c:Landroid/support/v7/app/b;
...
.method public final onLongClick(Landroid/view/View;)Z
    ...
    .line 524
    iget-object v5, p0, Landroid/support/v7/internal/widget/ar;->c:Landroid/support/v7/app/b;

    invoke-virtual {v5}, Landroid/support/v7/app/b;->f()Ljava/lang/CharSequence;
