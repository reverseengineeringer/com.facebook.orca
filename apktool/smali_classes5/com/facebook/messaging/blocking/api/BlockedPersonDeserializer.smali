.class public Lcom/facebook/messaging/blocking/api/BlockedPersonDeserializer;
.super Lcom/facebook/common/json/FbJsonDeserializer;
.source "BlockedPersonDeserializer.java"
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 28
    const-class v0, Lcom/facebook/messaging/blocking/api/BlockedPerson;

    new-instance v1, Lcom/facebook/messaging/blocking/api/BlockedPersonDeserializer;

    invoke-direct {v1}, Lcom/facebook/messaging/blocking/api/BlockedPersonDeserializer;-><init>()V

    invoke-static {v0, v1}, Lcom/facebook/common/json/j;->a(Ljava/lang/Class;Lcom/fasterxml/jackson/databind/JsonDeserializer;)V

    .line 40
    invoke-static {}, Lcom/facebook/messaging/blocking/api/BlockedPersonDeserializer;->e()Ljava/util/Map;
...
.method private static declared-synchronized e()Ljava/util/Map;
    ...
    .prologue
    .line 44
    const-class v1, Lcom/facebook/messaging/blocking/api/BlockedPersonDeserializer;

    monitor-enter v1

    :try_start_0
    sget-object v0, Lcom/facebook/messaging/blocking/api/BlockedPersonDeserializer;->a:Ljava/util/Map;
    :try_end_0
    ...
    const-class v3, Lcom/facebook/messaging/blocking/api/BlockedPerson;

    const-string v4, "mFbid"
    ...
    .line 49
    const-string v2, "block_time"

    const-class v3, Lcom/facebook/messaging/blocking/api/BlockedPerson;

    const-string v4, "mBlockedDate"
    ...
    sput-object v0, Lcom/facebook/messaging/blocking/api/BlockedPersonDeserializer;->a:Ljava/util/Map;
    :try_end_1
