...
.method public constructor <init>(Lcom/facebook/android/maps/model/LatLng;FFF)V
    ...
    .line 118
    iput p2, p0, Lcom/facebook/android/maps/model/f;->b:F

    .line 119
    iput p3, p0, Lcom/facebook/android/maps/model/f;->c:F

    .line 120
    iput p4, p0, Lcom/facebook/android/maps/model/f;->d:F

    .line 121
    return-void
.end method

.method public static a(Landroid/util/AttributeSet;)Lcom/facebook/android/maps/model/f;
    .locals 12
    ...
    invoke-direct {v0, v5, v1, v4, v6}, Lcom/facebook/android/maps/model/f;-><init>(Lcom/facebook/android/maps/model/LatLng;FFF)V
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    .line 141
    :cond_1
    instance-of v2, p1, Lcom/facebook/android/maps/model/f;
    ...
    .line 145
    :cond_2
    check-cast p1, Lcom/facebook/android/maps/model/f;

    .line 146
    iget v2, p0, Lcom/facebook/android/maps/model/f;->d:F

    iget v3, p1, Lcom/facebook/android/maps/model/f;->d:F

    cmpl-float v2, v2, v3

    if-nez v2, :cond_3

    iget-object v2, p0, Lcom/facebook/android/maps/model/f;->a:Lcom/facebook/android/maps/model/LatLng;

    if-nez v2, :cond_4

    iget-object v2, p1, Lcom/facebook/android/maps/model/f;->a:Lcom/facebook/android/maps/model/LatLng;
    ...
    iget-object v3, p1, Lcom/facebook/android/maps/model/f;->a:Lcom/facebook/android/maps/model/LatLng;
    ...
    iget v2, p0, Lcom/facebook/android/maps/model/f;->c:F

    iget v3, p1, Lcom/facebook/android/maps/model/f;->c:F

    cmpl-float v2, v2, v3

    if-nez v2, :cond_3

    iget v2, p0, Lcom/facebook/android/maps/model/f;->b:F

    iget v3, p1, Lcom/facebook/android/maps/model/f;->b:F
...
.method public final hashCode()I
    ...
    .line 126
    iget-object v1, p0, Lcom/facebook/android/maps/model/f;->a:Lcom/facebook/android/maps/model/LatLng;
    ...
    iget v1, p0, Lcom/facebook/android/maps/model/f;->c:F
    ...
    iget v1, p0, Lcom/facebook/android/maps/model/f;->d:F
