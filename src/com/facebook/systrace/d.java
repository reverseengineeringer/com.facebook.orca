...
public final class d
{
  public static boolean a()
  {
    ...
    for (;;)
    {
      ...
      return false;
      label48:
      Boolean localBoolean = (Boolean)c.a(c.c, new Object[] { Long.valueOf(l) });
  ...
  public static String c()
  {
    ...
    //   0: aconst_null
    //   1: astore_3
    //   2: new 59	java/io/FileReader
    //   5: dup
    //   6: ldc 61
    //   8: invokespecial 64	java/io/FileReader:<init>	(Ljava/lang/String;)V
    //   11: astore 4
    //   13: new 66	java/io/BufferedReader
    //   16: dup
    //   17: aload 4
    //   19: invokespecial 69	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   22: astore 5
    //   24: aload 5
    //   26: invokevirtual 72	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   29: astore_2
    //   30: aload_2
    //   31: iconst_0
    //   32: invokevirtual 78	java/lang/String:indexOf	(I)I
    //   35: istore_0
    //   36: aload_2
    //   37: astore_1
    //   38: iload_0
    ...
    //   43: iconst_0
    //   44: iload_0
    //   45: invokevirtual 82	java/lang/String:substring	(II)Ljava/lang/String;
    //   48: astore_1
    //   49: aload 5
    //   51: invokevirtual 85	java/io/BufferedReader:close	()V
    //   54: aload 4
    //   56: invokevirtual 86	java/io/FileReader:close	()V
    //   59: aload_1
    //   60: areturn
    //   61: astore_2
    //   62: aload_2
    ...
    //   95: dup
    //   96: aload_1
    //   97: invokespecial 91	java/lang/RuntimeException:<init>	(Ljava/lang/Throwable;)V
    //   100: athrow
    //   101: astore 5
    //   103: aload_2
    //   104: aload 5
    //   106: invokestatic 97	com/facebook/androidcompat/AndroidCompat:addSuppressed	(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
    //   109: goto -35 -> 74
    //   112: aload 5
    //   114: invokevirtual 85	java/io/BufferedReader:close	()V
    //   117: goto -43 -> 74
    //   120: astore_3
    //   121: aload_2
    //   122: aload_3
    //   123: invokestatic 97	com/facebook/androidcompat/AndroidCompat:addSuppressed	(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
    //   126: goto -37 -> 89
    //   129: aload 4
    //   131: invokevirtual 86	java/io/FileReader:close	()V
    //   134: goto -45 -> 89
    //   137: astore_1
    //   138: aconst_null
    //   139: astore_2
...
/* Location:
 * Qualified Name:     com.facebook.systrace.d
