  ...
  extends y
{
  ...
  e(d paramd, s params)
  {
    ...
    //   0: aload_0
    //   1: aload_1
    //   2: putfield 14	com/facebook/soloader/e:a	Lcom/facebook/soloader/d;
    //   5: aload_0
    //   6: invokespecial 17	com/facebook/soloader/y:<init>	()V
    //   9: aload_1
    //   10: getfield 23	com/facebook/soloader/s:e	Landroid/content/Context;
    //   13: astore_1
    ...
    //   311: checkcast 127	com/facebook/soloader/g
    //   314: getfield 133	com/facebook/soloader/u:c	Ljava/lang/String;
    //   317: aload 15
    //   319: invokevirtual 136	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   322: ifeq +60 -> 382
    //   325: iconst_1
    //   326: istore 4
    //   328: iload 4
    ...
    //   337: iconst_1
    //   338: iadd
    //   339: invokevirtual 139	java/lang/String:substring	(I)Ljava/lang/String;
    //   342: astore 16
    //   344: aload 11
    //   346: new 127	com/facebook/soloader/g
    //   349: dup
    //   350: aload 15
    //   352: aload 16
    ...
    //   365: invokespecial 142	com/facebook/soloader/g:<init>	(Ljava/lang/String;Ljava/lang/String;Ljava/io/File;)V
    //   368: invokevirtual 143	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   371: pop
    //   372: goto -208 -> 164
    //   375: astore_1
    //   376: aload 8
    ...
    //   410: aload_2
    //   411: aload 8
    //   413: invokestatic 149	com/facebook/androidcompat/AndroidCompat:addSuppressed	(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
    //   416: goto -174 -> 242
    //   419: aload 10
    ...
    //   429: aload_2
    //   430: aload 8
    //   432: invokestatic 149	com/facebook/androidcompat/AndroidCompat:addSuppressed	(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
    //   435: goto -178 -> 257
    //   438: aload 9
    ...
    //   447: aload 12
    //   449: aload 12
    //   451: invokeinterface 150 1 0
    //   456: anewarray 92	java/lang/String
    //   459: invokeinterface 154 2 0
    //   464: checkcast 156	[Ljava/lang/String;
    //   467: invokevirtual 159	com/facebook/soloader/s:a	([Ljava/lang/String;)V
    //   470: aload_0
    //   471: aload 11
    //   473: aload 11
    //   475: invokevirtual 121	java/util/ArrayList:size	()I
    //   478: anewarray 127	com/facebook/soloader/g
    //   481: invokevirtual 160	java/util/ArrayList:toArray	([Ljava/lang/Object;)[Ljava/lang/Object;
    //   484: checkcast 161	[Lcom/facebook/soloader/g;
    //   487: putfield 163	com/facebook/soloader/e:b	[Lcom/facebook/soloader/g;
    //   490: return
    //   491: iconst_0
    //   492: istore 4
    //   494: goto -166 -> 328
